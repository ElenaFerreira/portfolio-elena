    ...
    >
      ...
      <div className="relative">
        ...
        <div className="flex flex-col gap-1 md:gap-2">
          <div className="flex items-center py-4 gap-2 z-40">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start w-full ">
              ...
              <div className="text-left md:text-right w-full md:w-auto">
                <p className="font-bold text-sm text-title">École Futée</p>
          ...
          {[
            { title: experience_T("exp2"), company: "Grafikmente", years: experience_T("date2") },
            { title: experience_T("exp3"), company: "Marquetis & Co", years: experience_T("date3") },
            { title: experience_T("exp4"), company: "Grafikmente", years: experience_T("date4") },
          ].map((job, index) => (
