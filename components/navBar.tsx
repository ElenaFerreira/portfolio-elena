...
export default function NavBar() {
  ...
  return (
    <div
      className="relative w-fit bg-navbar-background rounded-full p-2 my-6 flex gap-2 z-20"
      ref={menuRef}
      role="group"
      aria-label={menu_T("label")}
    >
      ...
      {menuItems.map((item, index) => (
        <button
          ...
          className={`relative w-24 sm:w-32 cursor-pointer text-center border-2 border-transparent rounded-full px-4 py-2 z-10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary ${
